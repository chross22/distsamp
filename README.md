...
> **The bundled example is mock data.** `narwc-example.csv` is a *synthetic*
> two-day survey generated by `data-raw/make-fixture.R`, modelled on the
> hypothetical survey in Figure 2 of the handbook. No real NARWC records are
> distributed with this package, and none have been used to develop it — every
> number below is invented. Right whale sighting data is not ours to
> redistribute; request it from the
